...
<script>
    ...
    function submitMachineUpdate() {
        const machineManageNo = document.getElementById('editMachineManageNo').value;
        const machineStatus = document.getElementById('editMachineStatus').value;
        const machineCheckedDate = document.getElementById('editMachineCheckedDate').value;
        const machineNextCheck = document.getElementById('editMachineNextCheck').value;
    ...
    function submitLockerRegistration() {
        const lockerRealNum = document.getElementById('lockerRealNum').value.trim();
