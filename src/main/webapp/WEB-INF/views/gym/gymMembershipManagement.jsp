                ...
                <div class="product-header">
                    ...
                    <div class="product-actions">
                        <button class="edit-btn" onclick="startEdit(\${product.id})">
                            <img src="${pageContext.request.contextPath}/resources/images/icon/edit.png" alt="수정" class="detail-icon">
                        </button>
                        <button class="delete-btn" onclick="deleteProduct(\${product.id})">
                            <img src="${pageContext.request.contextPath}/resources/images/icon/delete.png" alt="삭제" class="detail-icon">
                        </button>
                    </div>
                </div>
