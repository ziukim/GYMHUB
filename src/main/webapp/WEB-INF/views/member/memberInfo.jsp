            ...
            <c:choose>
                <c:when test="${hasGym}">
                    ...
                    <div class="info-card">
                        ...
                        <c:choose>
                            <c:when test="${not empty ptSummary and ptSummary.totalCount > 0}">  <!-- 수정 -->
                                <div class="card-content">
                                    <p class="pt-count">${ptSummary.usedCount} / ${ptSummary.totalCount}회</p>
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 8px;">
                                        ...
                                        ${ptSummary.progressRate}%  <!-- 통일 -->
                                    </span>
                                    </div>

                                    <p class="pt-remaining">남은 PT: ${ptSummary.remainingCount}회</p>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div class="card-content" style="text-align:center; color:#8a6a50;">
        ...
        <div class="modal-body">
            <div style="margin-bottom: 20px; padding: 15px; background-color: #2d1810; border: 1px solid #ff6b00; border-radius: 8px;">
                <p style="color: #ffa366; margin: 0; line-height: 1.6;">
                    ...
                    • 진행 중인 회원권, PT, 락커 등 모든 서비스가 즉시 중단됩니다.<br>
                    • 탈퇴 후 동일한 아이디로 재가입이 제한될 수 있습니다.
                </p>
            </div>
            <form id="withdrawForm" action="${pageContext.request.contextPath}/withdrawMember.me" method="post">
                <div class="modal-form-group">
